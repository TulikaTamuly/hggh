...
function preload(){
  ...
  waterSound=loadSound("Voice0059.aac")
  waterSound2=loadSound("Voice0060.aac")
  foodSound=loadSound("Voice0058.aac")
}
function setup(){
...
//}
  ...
  if(x.lifetime>0){
    ...
    text("They can even talk!",350,430)
    text("I am sure you'd help. So bye and take care",350,450)
